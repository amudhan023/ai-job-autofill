...
| T5 | **E2E coverage expansion**: Playwright specs for (a) multi-page fill session auto-continue, (b) resume auto-attach to a file input, (c) AI-draft flow against a stubbed backend. | T1 | in-progress | Only 3 E2E specs exist today; these are the highest-risk untested flows. |
